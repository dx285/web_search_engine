...
public class HTMLParser {
	...
	public static void main(String[] args) {
		...
		parsePage("This is <b>so</b>    <H6>is very very <b><em>much</h6> fun</em></b>", a);
		Iterator i = a.listIterator();
		System.out.println("size:"+a.size());
		//parsePage("www.google.com", "This is <b>so</b>    <H6>very <b><em>much</h6> fun</em></b>", builder);
		while(i.hasNext()){
	 ...
	 * </ul>
	 * <p>
	 * For performance, this class uses StringBuilder instead of StringBuffer.
	 * If syncronization is required, provide syncronization outside of calling
	 * this class.
	 * 
	 * @param url
	 *            The url of the page being parsed
	 * @param doc
	 *            The page (including headers) of the page being parsed
	 * @param builder
...
/**
	...
	/**
	 * Assumes tag starts with a "<" and ends with either a ">" or a whitespace
	 * character
	 */
	static int parseTag(String tag) {
		...
		case 'S':
			...
			if ("trong".equalsIgnoreCase(safeSubstring(tag, i, i + 5)) && isEndTag(tag, i + 5)) {
				return Tags.PTAG_B;
			} else if ("cript".equalsIgnoreCase(safeSubstring(tag, i, i + 5)) && isEndTag(tag, i + 5)) {
	...
	public static void parsePage(String doc, List<String> list) {
		int docIndex = 0;
		int tagIndex = 0;
		int wordIndex;
		...
		while (docIndex < docLength) {
			...
			list.add(new String(doc.substring(wordIndex, docIndex).toLowerCase()));
		}
	}
}
